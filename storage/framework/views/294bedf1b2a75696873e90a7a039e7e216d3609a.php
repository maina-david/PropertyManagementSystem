               ...
               <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <?php if($product->businessID == Auth::user()->businessID): ?>
                     <tr>
                        ...
                        <td>
                           <a href="<?php echo e(route('finance.products.details', $product->proID)); ?>" class="btn btn-warning btn-sm"><i class="fas fa-eye"></i></a>
                           <?php if (app('laratrust')->isAbleTo('update-products')) : ?>
                              <a href="<?php echo e(route('finance.products.edit', $product->proID)); ?>" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a>
                           <?php endif; // app('laratrust')->permission ?>
                           <?php if (app('laratrust')->isAbleTo('delete-products')) : ?>
                              <a href="<?php echo route('finance.products.destroy', $product->proID); ?>" class="btn btn-danger delete btn-sm"><i class="fas fa-trash"></i></a>
                           <?php endif; // app('laratrust')->permission ?>
                        </td>
                     </tr>
                  <?php endif; ?>
...
<?php /**PATH /var/www/propertywingu/cloud.propertywingu.com/resources/views/livewire/finance/products.blade.php ENDPATH**/ ?>