...
<div class="content">
	...
	<?php echo Form::open(array('route' => 'assets.store','enctype'=>'multipart/form-data', 'method'=>'post' )); ?>
			...
			<div class="col-md-6">
				<div class="panel panel-default">
                  ...
                  <div style="display: none" id="vehicle-details">
                     ...
                     <div class="form-group form-group-default">
							...
							<div class="form-group form-group-default">
								...
								<?php echo e(Form::select('vehicle_model',[], null, ['class' => 'form-control multiselect', 'id'=>'model'])); ?>
                  ...
                  <div class="form-group form-group-default">
							...
							<?php echo Form::text('purchase_date', null, array('class' => 'form-control datepicker', 'placeholder' => 'Enter date')); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/propertywingu/cloud.propertywingu.com/resources/views/app/assets/assets/create.blade.php ENDPATH**/ ?>