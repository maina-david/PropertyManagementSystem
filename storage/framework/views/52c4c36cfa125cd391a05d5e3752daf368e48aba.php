               ...
               <?php $__currentLoopData = $contacts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contact): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <?php if($contact->businessID == Auth::user()->businessID): ?>
                     <tr >
                        ...
                        <td>
                           <a href="<?php echo e(route('ecommerce.customers.edit', $contact->customerID)); ?>" class="btn btn-sm btn-primary"><i class="fas fa-edit"></i></a>
                           <a href="<?php echo route('ecommerce.customers.delete', $contact->customerID); ?>" class="delete btn btn-sm btn-danger"><i class="fal fa-trash-alt"></i></a>
                        </td>
                     </tr>
                  <?php endif; ?>
               <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH /var/www/propertywingu/cloud.propertywingu.com/resources/views/livewire/ecommerce/customers/index.blade.php ENDPATH**/ ?>