         ...
         <tbody> 
            <?php $__currentLoopData = $sales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
               <tr>
                  ...
                  <td align="right"><b><?php echo $sale->code; ?><?php echo number_format($sale->total); ?></b></td>
               </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <tr>
               <td><b>Total</b></td>
               <td><center><?php echo $countInvoice; ?></center></td>
               <td align="right"><b><?php echo Wingu::currency()->code; ?><?php echo number_format($sales->sum('total')); ?></b></td>
            </tr>
         </tbody>
      </table>
   </div>
</body>
</html><?php /**PATH /var/www/propertywingu/cloud.propertywingu.com/resources/views/templates/bootstrap-3/reports/sales/customer.blade.php ENDPATH**/ ?>