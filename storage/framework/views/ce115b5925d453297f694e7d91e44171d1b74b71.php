...
<script>
   $('a#addRows').cloneData({
      mainContainerId: 'lpoItem', // Main container Should be ID
   ...
   $(document).on('change', '.solsoCloneSelect2','.changesNo', function() {
      ...
      $.ajax({
         ...
         success:function(data) {
            inputPrice.val(data['buying_price']);
         }
      });
   });
...
<?php /**PATH /var/www/propertywingu/cloud.propertywingu.com/resources/views/app/finance/partials/_lpo.blade.php ENDPATH**/ ?>