                     ...
                     <div class="email-head">
                        ...
                        <div class="email-head-sender d-flex align-items-center justify-content-between flex-wrap">
                           <div class="d-flex align-items-center">
                              <div class="avatar">
                                 <?php if($lead->image != ""): ?>
                                    <img class="rounded-circle user-avatar-md" alt="" class="<?php echo $lead->names; ?>" src="<?php echo asset('businesses/'.$lead->businessID.'/clients/'.$lead->customer_code.'/images/'.$lead->image); ?>" style="width:50px;height:50px">
                                 <?php else: ?>
...
</div><?php /**PATH /var/www/propertywingu/cloud.propertywingu.com/resources/views/app/crm/leads/mail/details.blade.php ENDPATH**/ ?>