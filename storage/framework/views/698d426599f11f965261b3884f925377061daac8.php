<div class="row">
   <div class="col-md-12 mb-2">
      <a href="<?php echo route('licenses.maintenances.create',$details->id); ?>" class="btn btn-pink pull-right"><i class="fas fa-plus-circle"></i> Add Maintenance</a>
   </div>
   <div class="col-md-12">
         ...
         <tbody>
            <?php $__currentLoopData = $maintenances; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $maintenance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
               <tr>
                  ...
                  <td>
                     <a href="<?php echo route('licenses.maintenances.edit',[$details->id,$maintenance->id]); ?>" class="btn btn-primary btn-sm"><i class="fal fa-edit"></i></a>
                     <a href="<?php echo route('licenses.maintenances.delete',[$details->id,$maintenance->id]); ?>" class="btn btn-sm btn-danger delete"><i class="fal fa-trash"></i></a>
                  </td>
               </tr>
...
</div> <!-- row --><?php /**PATH /var/www/propertywingu/cloud.propertywingu.com/resources/views/app/assets/licenses/show/maintenances.blade.php ENDPATH**/ ?>