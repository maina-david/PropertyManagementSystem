         ...
         <div class="col-md-4">
            <table>
               ...
               <tr class="mb-2">
                  ...
                  <td>
                     <?php if($address->bill_country != ""): ?>
                        <span class="text-pink"> <?php echo Wingu::country($address->bill_country)->name; ?></span>
                     <?php endif; ?>
                  </td>
               </tr>
               <tr class="mb-2">
...
<?php /**PATH /var/www/propertywingu/cloud.propertywingu.com/resources/views/app/crm/leads/view.blade.php ENDPATH**/ ?>