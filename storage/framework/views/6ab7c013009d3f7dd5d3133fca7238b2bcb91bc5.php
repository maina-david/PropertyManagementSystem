      ...
      <address>
         ...
         <span>
            ...
            <?php if($show->bill_country != ""): ?>
               <?php echo Wingu::country($show->bill_country)->name; ?><br>
            <?php endif; ?>
         </span>
...
</div><?php /**PATH /var/www/propertywingu/cloud.propertywingu.com/resources/views/templates/bootstrap-3/creditnote/preview.blade.php ENDPATH**/ ?>