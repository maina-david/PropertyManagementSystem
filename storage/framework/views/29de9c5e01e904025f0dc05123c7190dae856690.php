...
<?php $__currentLoopData = $tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
   <div class="widget-list-item mb-1">
      ...
      <div class="widget-list-content">
         ...
         <a href="<?php echo route('crm.deals.task.delete',$task->id); ?>" class="float-right ml-2 badge badge-danger delete"><i class="fas fa-trash"></i> Delete</a>
   ...
   <div class="modal fade" id="update-task-<?php echo $task->id; ?>" tabindex="-1" role="dialog">
      <div class="modal-dialog modal-lg">
         <?php echo Form::model($task, ['route' => ['crm.deals.task.update', $task->id], 'method'=>'post', 'autocomplete'=>'off']); ?>
               ...
               <div class="row">
                  <div class="col-sm-6">
   						<div class="form-group form-group-default required">
   							...
   							<?php echo Form::text('date', null, array('class' => 'form-control datepicker', 'placeholder' => '')); ?>
...
<div class="modal fade" id="create-task" tabindex="-1" role="dialog">
   <div class="modal-dialog modal-lg">
      <form action="<?php echo route('crm.deals.task.store',$deal->dealID); ?>" method="post" autocomplete="off">
         <div class="modal-content">
            <div class="modal-header">
               <h4 class="modal-title">Add Task</h4>
               <button type="button" class="close" data-dismiss="modal">&times;</button>
               ...
               <div class="row">
                  <div class="col-sm-6">
                     <div class="form-group form-group-default required">
                        ...
                        <?php echo Form::text('date', null, array('class' => 'form-control datepicker', 'placeholder' => 'Choose date')); ?>
...
<?php /**PATH /var/www/propertywingu/cloud.propertywingu.com/resources/views/app/crm/deals/deal/task.blade.php ENDPATH**/ ?>