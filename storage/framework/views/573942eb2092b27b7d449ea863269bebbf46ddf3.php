...
<head>
   ...
   <title>Purchase Order | <?php echo $details->prefix; ?><?php echo $details->number; ?></title>
            ...
            <table style="width: 100%">
               <tbody>
                  <tr>
                     ...
                     <td>: <?php echo $details->prefix; ?><?php echo $details->number; ?></td>
                  </tr>
         ...
         <tbody>
            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
               <tr class="item-row">
                  ...
                  <td>
                     <?php echo $details->code; ?> <?php echo e(number_format($product->price)); ?> 
                  </td>
                  <td>
                     <?php echo $details->code; ?> <?php echo e(number_format($product->price * $product->quantity)); ?> 
                  </td>
               </tr>
...
<?php /**PATH /var/www/propertywingu/cloud.propertywingu.com/resources/views/templates/bootstrap-3/lpo/lpo.blade.php ENDPATH**/ ?>