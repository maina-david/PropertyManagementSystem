   ...
   <?php $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
      ...
      <div class="modal fade" id="edit-event-<?php echo $event->id; ?>" tabindex="-1" role="dialog">
         <div class="modal-dialog modal-lg">
            <?php echo Form::model($event, ['route' => ['crm.leads.events.update', $event->id], 'method'=>'post', 'autocomplete'=>'off']); ?>
...
<div class="modal fade" id="create-event" tabindex="-1" role="dialog">
   <div class="modal-dialog modal-lg">
      <?php echo Form::open(array('route' => 'crm.leads.events.store','method' =>'post','autocomplete'=>'off')); ?>
...
<?php /**PATH /var/www/propertywingu/cloud.propertywingu.com/resources/views/app/crm/leads/events/index.blade.php ENDPATH**/ ?>