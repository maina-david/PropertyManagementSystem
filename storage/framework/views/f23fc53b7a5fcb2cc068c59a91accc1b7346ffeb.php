<?php $__env->startSection('title'); ?> Propery | Add  <?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
   <div id="content" class="content">
      ...
      <!-- end breadcrumb -->
      <!-- begin page-header -->
      <h1 class="page-header"><i class="fal fa-home"></i> Propery | Add</h1>
      <div class="row">
         <div class="col-md-12">
            <?php echo $__env->make('partials._messages', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php echo Form::open(array('route' => 'property.store','enctype'=>'multipart/form-data','method'=>'post','autocomplete' => '')); ?>
                     ...
                     <div class="row">
                        <div class="col-md-4">
                           <div class="form-group form-group-default required ">
                              ...
                              <select name="property_type" id="type" class="form-control multiselect" required>
                        ...
                        <div class="col-md-4">
                           <div class="form-group form-group-default required ">
                              ...
                              <?php echo Form::select('country', $country, null, array('class' => 'form-control multiselect', 'required' => '')); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/propertywingu/cloud.propertywingu.com/resources/views/app/property/property/create.blade.php ENDPATH**/ ?>