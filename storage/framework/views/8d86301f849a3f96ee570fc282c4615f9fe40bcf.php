      ...
      <div class="row">
         ...
         <div class="col-md-6">
            <div class="card">
               ...
               <div class="card-body">
                  <?php echo Form::model($edit, ['route' => ['crm.pipeline.update', $edit->id], 'method'=>'post', 'autocomplete' => 'off']); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/propertywingu/cloud.propertywingu.com/resources/views/app/crm/deals/pipelines/pipeline/edit.blade.php ENDPATH**/ ?>