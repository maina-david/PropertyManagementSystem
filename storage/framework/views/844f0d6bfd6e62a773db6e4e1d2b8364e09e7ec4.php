            ...
            <div class="widget-list-item">
               ...
               <div class="widget-list-action">
                  ...
                  <ul class="dropdown-menu dropdown-menu-right">
                     ...
                     <li><a href="<?php echo asset('businesses/'.Wingu::business(Auth::user()->businessID)->businessID.'/customer/'.$client->reference_number.'/'.$document->file_name); ?>" target="_blank">View document</a></li>
                     <li><a href="<?php echo route('crm.leads.documents.delete',[$document->id,$customerID]); ?>" class="delete">Delete</a></li>
                  </ul>
               </div>
            </div>
...
<?php /**PATH /var/www/propertywingu/cloud.propertywingu.com/resources/views/app/crm/customers/documents.blade.php ENDPATH**/ ?>