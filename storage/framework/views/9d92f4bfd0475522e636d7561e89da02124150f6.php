			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="form-group form-group-default required">
						...
						<?php echo Form::select('employee[]',$employees,null,['class'=>'form-control multiselect','required'=>'','multiple'=>'']); ?>

					</div>
					<div class="form-group form-group-default required">
						<label class="text-danger">Employee Department</label>
						<?php echo Form::select('department[]',$departments,null,['class'=>'form-control multiselect','required'=>'','multiple'=>'']); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/propertywingu/cloud.propertywingu.com/resources/views/app/hr/travel/create.blade.php ENDPATH**/ ?>