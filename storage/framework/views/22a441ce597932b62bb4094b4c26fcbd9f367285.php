<div class="col-md-12">
   <div class="row">
      <div class="col-md-4">
         <img src="<?php echo asset('businesses/'.$business->businessID.'/documents/images/'.$business->logo); ?>" class="logo" alt="<?php echo $business->businessName; ?>" style="width:80%">
      </div>
      <div class="col-md-4">
      </div>
      <div class="col-md-4">
         ...
         <table style="float:left">
            <tbody>
               <tr>
                  ...
                  <td>: <?php echo $invoice->utility_No; ?></td>
               </tr>
               <tr>
                  <th>Bill Number</th>
               ...
               <?php if($invoice->invoiceStatusID != 1): ?>
                  <?php if($invoice->invoiceStatusID == 3): ?>
                     <tr>
                        <th>Balance</th>
                        <td><span class="text-right">: <?php echo $business->code; ?> <?php echo number_format($invoice->invoice_balance); ?> </span></td>
                     </tr>
   ...
   <table class="table table-striped table-bordered mt-3">
      ...
      <tbody>
         <tr class="item-row">
            ...
            <td><?php echo e($product->previous_units); ?></td>
            <td><?php echo e($product->current_units); ?></td>
         ...
         <?php if($invoice->amount_paid != "" || $invoice->amount_paid != 0): ?>
            <?php if($balance != 0): ?>
               <tr>
                  <td></td>
                  <td colspan="5">Account Arrears</td>
                  <td><?php echo $business->code; ?> <?php echo number_format($balance); ?></td>
               </tr>
            <?php endif; ?>
         <?php endif; ?>
      </tbody>
         ...
         <table class="table table-striped">
            <tbody> 
               <tr>
                  <th>Total Amount</th>
                  <td>
                     <strong>: <?php echo $business->code; ?> <?php if($balance != 0): ?> <?php echo number_format($balance); ?> <?php else: ?> <?php echo number_format($invoice->total); ?> <?php endif; ?></strong>
                  </td>
               </tr>
            </tbody>
         </table>
...
</div><?php /**PATH /var/www/propertywingu/cloud.propertywingu.com/resources/views/templates/bootstrap-3/utility/preview.blade.php ENDPATH**/ ?>