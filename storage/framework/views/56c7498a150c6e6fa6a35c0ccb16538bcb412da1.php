            ...
            <div class="widget-list-item">
               ...
               <div class="widget-list-action">
                  ...
                  <ul class="dropdown-menu dropdown-menu-right">
                     ...
                     <li><a href="<?php echo asset('businesses/'.Wingu::business(Auth::user()->businessID)->businessID.'/customer/'.$lead->reference_number.'/'.$document->file_name); ?>" target="_blank">View document</a></li>
...
<?php /**PATH /var/www/propertywingu/cloud.propertywingu.com/resources/views/app/crm/leads/documents/index.blade.php ENDPATH**/ ?>