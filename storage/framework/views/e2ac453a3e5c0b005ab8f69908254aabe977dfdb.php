<?php $__env->startSection('title','Add New | Invoice'); ?>
...
<?php $__env->startSection('content'); ?>
   <div id="content" class="content">
      ...
      <?php echo e(Form::open(array('route' => 'finance.invoice.product.store', 'role' => 'form', 'class' => 'solsoForm'))); ?>
            ...
            <div class="panel-body">
               <div class='row mt-3'>
                  <div class="col-md-6 mt-3">
                     ...
                     <textarea name="customer_note" class="form-control ckeditor" rows="8" cols="80"><?php echo Finance::invoice_settings()->default_customer_notes; ?></textarea>
                  </div>
                  <div class="col-md-6 mt-3">
                     <label for="">Terms & Conditions</label>
                     <textarea name="terms" class="form-control ckeditor" rows="8" cols="80"><?php echo Finance::invoice_settings()->default_terms_conditions; ?></textarea>
                  </div>
               </div>
            </div>
         </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/propertywingu/cloud.propertywingu.com/resources/views/app/finance/invoices/product/create.blade.php ENDPATH**/ ?>