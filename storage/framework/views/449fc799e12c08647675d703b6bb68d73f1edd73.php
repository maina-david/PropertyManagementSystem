...
<?php $__env->startSection('content'); ?>
   ...
   <div id="content" class="content">
      ...
      <?php echo Form::model($role, ['route' => ['settings.roles.update',$role->id], 'method'=>'post','data-parsley-validate' => '','enctype'=>'multipart/form-data','class' => 'mb-4']); ?>
         ...
         <div id="accordion" class="accordion">  
            <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
               <div class="card">
                  <div class="card-header pointer-cursor d-flex align-items-center" data-toggle="collapse" data-target="#collapse<?php echo $module->modID; ?>">
                     <?php echo $module->name; ?>

                  </div>
                  <div id="collapse<?php echo $module->modID; ?>" class="collapse" data-parent="#accordion">
                     <div class="card-body">
                        <div class="row">
                                 ...
                                 <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr> 
                                       <?php $__currentLoopData = Wingu::permissions_by_group($group->id); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                          <td>
                                             <div class="">
                                                <input type="checkbox" value="<?php echo $permission->id; ?>" name="permissions[]" <?php if($role->permissions->contains($permission->id)): ?> checked <?php endif; ?>>
                                                <?php
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/propertywingu/cloud.propertywingu.com/resources/views/app/settings/roles/edit.blade.php ENDPATH**/ ?>