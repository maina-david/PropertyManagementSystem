...
<?php $__currentLoopData = $notes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $note): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
   <div class="card">
      ...
      <div class="card-footer text-muted">
         <div class="row">
            ...
            <div class="col-md-4">
               <a href="<?php echo route('crm.leads.notes.delete', $note->id); ?>" class="btn btn-sm btn-danger float-right delete">Delete</a>
               <a href="#" data-toggle="modal" data-target="#edit-note-<?php echo $note->id; ?>" class="btn btn-sm float-right mr-2 btn-primary">Edit</i></a>
            </div>
         </div>
      </div>
   </div>
   <div class="modal fade" id="edit-note-<?php echo $note->id; ?>">
      <div class="modal-dialog modal-lg">
         <?php echo Form::model($note, ['route' => ['crm.leads.notes.update', $note->id], 'method'=>'post']); ?>
...
</div><?php /**PATH /var/www/propertywingu/cloud.propertywingu.com/resources/views/app/crm/leads/notes/notes.blade.php ENDPATH**/ ?>