...
<?php $__env->startSection('content'); ?> 
	<div id="content" class="content">
      ...
      <!-- begin widget-list -->
      <div class="row">
         <?php echo Form::model($edit, ['route' => ['hrm.departments.update',$edit->id], 'method'=>'post','class' => 'col-md-12']); ?>
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-3">
                        <div class="form-group form-group-default">
                           ...
                           <?php echo Form::select('parentID', $departments, null, array('class' => 'form-control multiselect')); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/propertywingu/cloud.propertywingu.com/resources/views/app/hr/organization/departments/edit.blade.php ENDPATH**/ ?>