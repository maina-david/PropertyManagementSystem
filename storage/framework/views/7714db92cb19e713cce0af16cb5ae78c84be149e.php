      ...
      <?php echo Form::open(array('route' => 'finance.lpo.store', 'enctype'=>'multipart/form-data','method' => 'post','autocomplete' => 'off')); ?>
         ...
         <div class='row mt-3'>
            <div class="col-md-6 mt-3">
               ...
               <textarea name="customer_note" class="form-control ckeditor" rows="8" cols="80"><?php echo Finance::lpo()->default_customer_notes; ?></textarea>
            </div>
            <div class="col-md-6 mt-3">
               <label for="">Terms & Conditions</label>
               <textarea name="terms" class="form-control ckeditor" rows="8" cols="80"><?php echo Finance::lpo()->default_terms_conditions; ?></textarea>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/propertywingu/cloud.propertywingu.com/resources/views/app/finance/purchaseorders/create.blade.php ENDPATH**/ ?>