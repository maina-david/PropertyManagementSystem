...
{{-- <script src="{!! asset('assetsunisharp/laravel-filemanager/js/stand-alone-button.js') !!}"></script>
...
<script src="{!! asset('assets/plugins/isotope-layout/dist/isotope.pkgd.min.js') !!}" type="a4fa74d6c7c0c2d9928dd7e0-text/javascript"></script>
