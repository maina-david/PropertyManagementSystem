<div class="col-md-12">
   <div class="row">
      <div class="col-md-4">
         @if($business->logo != "") 
            <img src="{!! asset('businesses/'.$business->businessID.'/documents/images/'.$business->logo) !!}" class="logo" alt="{!! $business->businessName !!}" style="width:70%">
         @endif
      </div>
      <div class="col-md-4">
      </div>
      ...
      <div class="col-md-6">
         <table class="table table-striped">
            <tbody>             
               <tr>
                  <th>Sub Total</th>
                  <td><strong>: {!! $business->code !!} {!! number_format($invoice->sub_total) !!} <strong></td>
               </tr>
               @if($invoice->taxvalue != "")  
                  <tr>
                     <th>Tax</th>
