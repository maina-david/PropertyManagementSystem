                  ...
                  <tbody>
                     @if($details->statusID == 3)
                        <tr class="well" style="padding: 5px">
                           ...
                           <td style="padding: 5px" class="text-right"><strong> {!! $details->symbol !!}{!! number_format($details->balance,2) !!}</strong></td>
                        </tr>
                     @elseif($details->statusID == 2)
                        <tr class="well" style="padding: 5px">
                           <th style="padding: 5px"><div> Amount Due </div></th>
                           <td style="padding: 5px" class="text-right"><strong> {!! $details->symbol !!}{!! number_format($details->total,2) !!} </strong></td>
                        </tr>
                     @endif
                  </tbody>
               </table>
         ...
         <tbody>
            @foreach ($products as $product)
               <tr class="item-row">
                  ...
                  <td>
                     {!! $details->symbol !!}{{ number_format($product->selling_price,2) }}
                  </td>
                  @if($details->show_discount_tab == 'Yes')
                     @if($details->discount != "")
                        <td>
                     ...
                     <tbody>
                        @foreach ($payments as $payment)
                           <tr>
                              ...
                              <td>{!! $details->symbol !!}{!! number_format($payment->amount,2) !!} </td>
                              <td>{!! $details->symbol !!}{!! number_format($payment->balance,2) !!} </td>
                           </tr>
                        @endforeach
                     </tbody>
                  </table>
