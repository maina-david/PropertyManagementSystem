      ...
      <div class="row">
         <div class="col-md-6">
            <div class="card">
               ...
               <div class="card-body">
                  {!! Form::model($edit, ['route' => ['hrm.leave.update',$edit->id], 'method'=>'post','enctype'=>'multipart/form-data', 'autocomplete' => 'off']) !!}
                     @csrf
                     <div class="form-group form-group-default required">
      						{!! Form::label('names', 'Leave Type', array('class'=>'control-label')) !!}
      						{!! Form::select('leave_type', $types, null, array('class' => 'form-control multiselect', 'required' => '')) !!}
      					</div>
      					<div class="form-group form-group-default required">
      						{!! Form::label('Employee', 'Employee', array('class'=>'control-label')) !!}
      						{!! Form::select('employeeID', $employees, null, array('class' => 'form-control multiselect', 'required' => '')) !!}
      					</div>
                     <div class="row">
      						<div class="col-sm-6">
      							<div class="form-group form-group-default required">
