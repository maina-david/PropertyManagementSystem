...
@section('stylesheet')
	...
	<link href="{!! aaset('assets/plugins/fullcalendar/fullcalendar.print.css') !!}" rel="stylesheet" media='print' />
	<link href="{!! aaset('assets/plugins/fullcalendar/fullcalendar.min.css') !!}" rel="stylesheet" />
...
@section('scripts')
   ...
   {!! $calendar->script() !!}
   {{-- <!-- ================== BEGIN PAGE LEVEL JS ================== -->
	<script src="{!! aaset('assets/plugins/fullcalendar/lib/moment.min.js"></script>
	<script src="{!! aaset('assets/plugins/fullcalendar/fullcalendar.min.js"></script>
	<script src="{!! aaset('assets/js/demo/calendar.demo.min.js"></script>
	<!-- ================== END PAGE LEVEL JS ================== --> --}}
