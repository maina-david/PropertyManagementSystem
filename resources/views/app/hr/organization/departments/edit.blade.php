...
@section('content') 
	<div id="content" class="content">
      ...
      <!-- begin widget-list -->
      <div class="row">
         {!! Form::model($edit, ['route' => ['hrm.departments.update',$edit->id], 'method'=>'post','class' => 'col-md-12']) !!}
            @csrf
            <div class="card">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-3">
                        <div class="form-group form-group-default">
                           ...
                           {!! Form::select('parentID', $departments, null, array('class' => 'form-control multiselect')) !!}
                        </div>
                     </div>
                     <div class="col-md-3">
                        <div class="form-group form-group-default">
