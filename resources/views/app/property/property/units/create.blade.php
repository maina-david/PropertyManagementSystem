         ...
         <div class="col-md-12">
            <div class="panel panel-default">
               ...
               <div class="panel-body">
                  {!! Form::open(array('route' => 'property.units.store','enctype'=>'multipart/form-data','method'=>'post' )) !!}
                     {!! csrf_field() !!}
                     ...
                     <div class="row">
                        <div class="col-md-4">
                           <div class="form-group form-group-default required">
                              ...
                              {!! Form::select('property_type',[2 => 'Flat/Apartment',10 => 'Commercial Properties', 12 => 'Offices'], null, array('class' => 'form-control multiselect', 'id' => 'unit_type', 'required' => '')) !!}
                           </div>
                        </div>
                        <div class="col-md-4">
                           <div class="form-group form-group-default required ">
