      ...
      <div class="row">
                     ...
                     <table id="data-table-default" class="table table-striped table-bordered">
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td>{!! $group->name !!}</td>
                              <td>
                                 <a href="{!! route('crm.customers.groups.edit',$group->id) !!}" class="btn btn-pink btn-sm"><i class="far fa-edit"></i> Edit</a>
                                 <a href="{!! route('crm.customers.groups.delete',$group->id) !!}" class="btn btn-danger delete btn-sm"><i class="fas fa-trash"></i> Delete</a>
                              </td>
                           </tr>
                           @endforeach
                        </tbody>
         ...
         <div class="col-md-6">
            <div class="panel panel-default">
               ...
               <div class="panel-body">
                  <div class="panel-body">
                     {!! Form::model($edit, ['route' => ['crm.customers.groups.update',$edit->id], 'method'=>'post','enctype'=>'multipart/form-data']) !!}
                        @csrf
