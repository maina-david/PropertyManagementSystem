                     ...
                     <div class="email-head">
                        ...
                        <div class="email-head-sender d-flex align-items-center justify-content-between flex-wrap">
                           <div class="d-flex align-items-center">
                              <div class="avatar">
                                 @if($lead->image != "")
                                    <img class="rounded-circle user-avatar-md" alt="" class="{!! $lead->names !!}" src="{!! asset('businesses/'.$lead->businessID.'/clients/'.$lead->customer_code.'/images/'.$lead->image) !!}" style="width:50px;height:50px">
                                 @else
