<div class="col-lg-3 email-aside border-lg-right">
   <div class="aside-content">
      <div class="aside-compose"><a class="btn btn-primary btn-block" href="{!! route('crm.leads.send',$customerID) !!}"><i class="fas fa-paper-plane"></i> Compose Email</a></div>
      <div class="aside-nav collapse">
         <ul class="nav">         
            <li class="active">
               <a href="{!! route('crm.leads.mail',$customerID) !!}"><i class="fas fa-paper-plane"></i>&nbsp;&nbsp; Sent Mail </a>
            </li>
