            ...
            <div class="widget-list-item">
               ...
               <div class="widget-list-action">
                  ...
                  <ul class="dropdown-menu dropdown-menu-right">
                     ...
                     <li><a href="{!! asset('businesses/'.Wingu::business(Auth::user()->businessID)->businessID.'/customer/'.$lead->reference_number.'/'.$document->file_name) !!}" target="_blank">View document</a></li>
