   ...
   @foreach ($events as $event) 
      ...
      <div class="modal fade" id="edit-event-{!! $event->id !!}" tabindex="-1" role="dialog">
         <div class="modal-dialog modal-lg">
            {!! Form::model($event, ['route' => ['crm.leads.events.update', $event->id], 'method'=>'post', 'autocomplete'=>'off']) !!}
...
<div class="modal fade" id="create-event" tabindex="-1" role="dialog">
   <div class="modal-dialog modal-lg">
      {!! Form::open(array('route' => 'crm.leads.events.store','method' =>'post','autocomplete'=>'off')) !!}
         <div class="modal-content">
         <div class="modal-header">
