...
<div class="content">
   ...
   {!! Form::model($edit, ['route' => ['assets.update',$edit->id], 'method'=>'post','enctype' => 'multipart/form-data']) !!}
		@csrf
		<div class="row">
			<div class="col-md-6">
				<div class="panel panel-default">
                  ...
                  <div class="form-group form-group-default">
                     ...
                     <select name="asset_type" id="type" class="form-control multiselect">
								...
								@elseif($edit->asset_type == 1)
									<option value="1">Vehicle</option>
								@else
									<option value="{!! $edit->asset_type !!}">{!! Asset::type(2)->name !!}</option>
								@endif								
			...
			<div class="col-md-6">
				<div class="panel panel-default">
                  ...
                  <div class="form-group form-group-default">
							...
							{!! Form::text('accessories', null, array('class' => 'form-control','id'=>'accessories','placeholder' => 'Enter accessories')) !!}
                  </div>
                  <div class="form-group form-group-default">
                  ...
                  <div class="form-group form-group-default">
							...
							{!! Form::text('purchase_date', null, array('class' => 'form-control datepicker', 'placeholder' => 'Choose date')) !!}
                  </div>
                  <div class="form-group form-group-default">
