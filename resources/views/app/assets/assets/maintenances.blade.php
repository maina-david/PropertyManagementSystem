<div class="row">
   <div class="col-md-12 mb-2">
      <a href="{!! route('assets.maintenances.create',$details->id) !!}" class="btn btn-pink pull-right"><i class="fas fa-plus-circle"></i> Add Maintenance</a>
   </div>
   <div class="col-md-12">
         ...
         <tbody>
            @foreach($maintenances as $maintenance)
               <tr>
                  ...
                  <td>
                     <a href="{!! route('assets.maintenances.edit',[$details->id,$maintenance->id]) !!}" class="btn btn-primary btn-sm"><i class="fal fa-edit"></i></a>
