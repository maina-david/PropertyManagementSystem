...
@section('content')
   <div id="content" class="content">
      ...
      @include('partials._messages')
         {!! Form::model($quote, ['route' => ['finance.quotes.update',$quote->id], 'method'=>'post','data-parsley-validate' => '','enctype'=>'multipart/form-data']) !!}
            @csrf
            <div class="load-animate">
                  ...
                  <div class="col-md-4 col-lg-4">
                     <div class="form-group form-group-default">
                        ...
                        <select name="customer" class="form-control multiselect" required>
									<option selected value="{{ $quote->customerID }}">{!! $customer->customer_name !!}</option>
                           @foreach ($customers as $cli)
               ...
               <div class='row'>
                  <div class="col-md-4 col-lg-4">
                     <div class="form-group form-group-default">
                        ...
                        {!! Form::text('quote_date', null, array('class' => 'form-control datepicker', 'placeholder' => 'Date Create','required' => '')) !!}
                     </div>
                  </div>
                  <div class="col-md-4 col-lg-4">
                     <div class="form-group form-group-default">
                        <label for="end" class="text-danger">Expiry Date * </label>
                        {!! Form::text('quote_due', null, array('class' => 'form-control datepicker-rs', 'placeholder' => 'Expiry Date','required' => '')) !!}
                     </div>
                  </div>
                  <div class="col-md-4 col-lg-4">
                     <div class="form-group form-group-default">
                        <label for="end">Amounts are</label>
                        {!! Form::select('taxconfig',['Inclusive' => 'Tax Inclusive','Exclusive' => 'Tax Exclusive'],null,['class' => 'form-control', 'id' => 'taxconfig' ]) !!}
                     </div>
                  </div>
               </div>
               <div class="row">
                           ...
                           <table class="table table-bordered table-striped" id="invoiceItems">
                              ...
                              <tfoot>
                                 ...
                                 <tr id="taxfield">
                                    ...
                                    <td colspan="3">
                                       <h4 class="text-center">
                                          <input readonly type="number" class="form-control" value="{!! $quote->taxvalue !!}" id="taxvalue" step="0.01">
                                       </h4>
                                    </td>
                                 </tr>
               ...
               <div class='row'>
                <div class="col-md-6 mt-3">
                    ...
                    <textarea name="customer_note" class="form-control ckeditor" rows="8" cols="80">{!! $quote->customer_note !!}</textarea>
                </div>
                <div class="col-md-6 mt-3">
                    <label for="">Terms & Conditions</label>
                    <textarea name="terms" class="form-control ckeditor" rows="8" cols="80">{!! $quote->terms !!}</textarea>
