...
@section('content')
   <div id="content" class="content">
      ...
      @include('partials._messages')
		{{ Form::open(array('route' => 'finance.invoice.random.store')) }}
			@csrf
	                        ...
	                        <div class="form-group">
	                           ...
	                           <select name="client" class="form-control multiselect"  required>
	                              ...
	                              @foreach ($clients as $cli)
	                                 <option value="{{ $cli->id }}"> @if($cli->company_name != ""){!! $cli->company_name !!} @elseif($cli->client_name != "") {!! $cli->client_name !!}@endif </option>
	                              @endforeach
	                           </select>
	                        </div>
	                     </div>
