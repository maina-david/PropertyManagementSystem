...
@section('content')
   <div id="content" class="content">
      ...
      {!! Form::model($invoice, ['route' => ['finance.invoice.product.update',$invoice->invoiceID], 'method'=>'post']) !!}
         @csrf
         <div class='row'>
            ...
            <div class="panel-body">
               <div class='row mt-3'>
                  <div class="col-md-6 mt-3">
                     ...
                     <textarea name="customer_note" class="form-control ckeditor" rows="8" cols="80">{!! $invoice->customer_note !!}</textarea>
                  </div>
                  <div class="col-md-6 mt-3">
                     <label for="">Terms & Conditions</label>
                     <textarea name="terms" class="form-control ckeditor" rows="8" cols="80">{!! $invoice->terms !!}</textarea>
                  </div>
               </div>
            </div>
         </div>
