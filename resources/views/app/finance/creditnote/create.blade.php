...
@section('content')
   <div id="content" class="content">
      ...
      {{ Form::open(array('route' => 'finance.creditnote.store')) }}
         @csrf
         <div class='row'>
            ...
            <div class="col-md-6 col-lg-6">
               <div class="form-group">
                  ...
                  <div class="input-group">
                     ...
                     <input type="text" name="creditnote_number" class="form-control required no-line" autocomplete="off" value="{{ Finance::creditnote()->number + 1 }}" readonly>
                  </div>
         ...
         <div class='row mt-3'>
            <div class="col-md-6 mt-3">
               ...
               <textarea name="customer_note" class="form-control ckeditor" rows="8" cols="80">{!! Finance::creditnote()->default_customer_notes !!}</textarea>
            </div>
            <div class="col-md-6 mt-3">
               <label for="">Terms & Conditions</label>
               <textarea name="terms" class="form-control ckeditor" rows="8" cols="80">{!! Finance::creditnote()->default_terms_conditions !!}</textarea>
            </div>
