                ...
                @foreach($products as $key => $product)
                   @if($product->businessID == Auth::user()->businessID)
                     <tr>
                        ...
                        <td>
                           <a href="{{ route('pos.products.details', $product->proID) }}" class="btn btn-warning btn-sm"><i class="fas fa-eye"></i></a>
                           <a href="{{ route('pos.products.edit', $product->proID) }}" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a>
                           <a href="{!! route('pos.products.destroy', $product->proID) !!}" class="btn btn-danger delete btn-sm"><i class="fas fa-trash"></i></a>
                        </td>
                     </tr>
                   @endif
                @endforeach
