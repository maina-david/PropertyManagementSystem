...
class documentsController extends Controller
{
   ...
   */
   public function index($id)
   {
      ...
      return view('app.crm.customers.view', compact('client','customerID','contacts','documents'));
   }
   ...
   */
   ...
   {
      $lead = customers::where('businessID',Auth::user()->businessID)->where('id',$leadID)->first();
      $folder = 'customer/'.$lead->reference_number;
