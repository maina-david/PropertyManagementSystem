...
class statementController extends Controller
{
   ...
   public function index($id){
      ...
      return view('app.crm.customers.view', compact('client','customerID','contacts','invoicesBalance','invoicedAmount','amountReceived','invoices','invoiceSettings'));
   }
   ...
   public function send(Request $request){
      ...
      return redirect()->route('crm.customer.mail',$request->customerID);
   }
}
